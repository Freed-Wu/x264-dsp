...
#define SSD1                                                         \
	{                                                            \
		int d = pix1[y * i_pix1 + x] - pix2[y * i_pix2 + x]; \
		i_ssd += d * d;                                      \
	}
	if (i_width & 7) {
...
#define PIXEL_SATD(w, h, sub, cpu)                                                                                                                                      \
	static int x264_pixel_satd_##w##x##h##cpu(pixel *pix1, intptr_t i_pix1, pixel *pix2, intptr_t i_pix2) {                                                         \
		int sum = sub(pix1, i_pix1, pix2, i_pix2) + sub(pix1 + 4 * i_pix1, i_pix1, pix2 + 4 * i_pix2, i_pix2);                                                  \
		if (w == 16)                                                                                                                                            \
			sum += sub(pix1 + 8, i_pix1, pix2 + 8, i_pix2) + sub(pix1 + 8 + 4 * i_pix1, i_pix1, pix2 + 8 + 4 * i_pix2, i_pix2);                             \
		if (h == 16)                                                                                                                                            \
			sum += sub(pix1 + 8 * i_pix1, i_pix1, pix2 + 8 * i_pix2, i_pix2) + sub(pix1 + 12 * i_pix1, i_pix1, pix2 + 12 * i_pix2, i_pix2);                 \
		if (w == 16 && h == 16)                                                                                                                                 \
			sum += sub(pix1 + 8 + 8 * i_pix1, i_pix1, pix2 + 8 + 8 * i_pix2, i_pix2) + sub(pix1 + 8 + 12 * i_pix1, i_pix1, pix2 + 8 + 12 * i_pix2, i_pix2); \
		return sum;                                                                                                                                             \
	}
